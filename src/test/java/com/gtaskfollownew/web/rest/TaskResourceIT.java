package com.gtaskfollownew.web.rest;

import static com.gtaskfollownew.domain.TaskAsserts.*;
import static com.gtaskfollownew.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.gtaskfollownew.IntegrationTest;
import com.gtaskfollownew.domain.Task;
import com.gtaskfollownew.domain.enumeration.PriorityEnum;
import com.gtaskfollownew.domain.enumeration.StatusEnum;
import com.gtaskfollownew.repository.TaskRepository;
import com.gtaskfollownew.repository.UserRepository;
import com.gtaskfollownew.service.TaskService;
import com.gtaskfollownew.service.dto.TaskDTO;
import com.gtaskfollownew.service.mapper.TaskMapper;
...
class TaskResourceIT {
    ...
    private static final PriorityEnum DEFAULT_PRIORITY = PriorityEnum.LOW;
    private static final PriorityEnum UPDATED_PRIORITY = PriorityEnum.MEDIUM;

    private static final StatusEnum DEFAULT_STATUS = StatusEnum.TODO;
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).priority(UPDATED_PRIORITY).createdAt(UPDATED_CREATED_AT);
